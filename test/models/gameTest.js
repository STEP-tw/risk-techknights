...
describe("Game Model", () => {
  ...
  it(" should clear military units if phase is 4", () => {
    const game = new Game("12345", []);
    game.order = [1, 2];
    let player1 = new Player(1, "durga", 10);
    let player2 = new Player(2, "Tushar", 10);
    game.addPlayer(player1);
    game.addPlayer(player2);

    game.getCurrentPlayer().phase = 3;
...
describe("tradeCards", () => {
  it("should trade cards", () => {
    ...
    game.tradeCards();
    expect(player1)
      .has.property("receivedCards")
      .to.eql({ cards: ["Wildcard"] });
  });
});
...
describe("getHorsePosition", () => {
  it("should return the current horse position", () => {
    ...
    expect(game)
      .has.property("currentHorseIndex")
      .to.equal(16);
  });
});
